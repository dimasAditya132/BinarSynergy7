...
public class ProductUtil {
    ...
    public Product createUtil(String productName, Double price, String merchantId) {
        Merchant merchant;
        Product product;
        try {
    ...
    public Product editProduct(String productId, @Nullable String newProductName, @Nullable Double newPrice) {
        ...
        try {
            ...
            try {
                ...
                log.error(e.getLocalizedMessage());
                System.out.println("Update product \"" + product.getProductName() + "\" from merchant \"" + product.getMerchant().getMerchantName() + "\" is failed");
            }
            return product;
        } catch (RuntimeException e) {
            log.error(e.getLocalizedMessage());
